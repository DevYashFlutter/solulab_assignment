                    ...
                    children: [
                      ...
                      Positioned.fill(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border.all(
                              color: hasDetails && details!.isValid
                                  ? const Color(0xFF10B981)
                                  : const Color(0xFF0F56FA).withOpacity(0.8),
                              width: 2.5,
                            ),
                  ...
                  child: const Row(
                    children: [
                      SizedBox(
                        ...
                        child: CircularProgressIndicator(
                          strokeWidth: 2,
                          valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF0F56FA)),
                        ),
                      ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _DetailRow(
                        label: 'Card Number',
                        value: _maskCardNumber(details.cardNumber),
                        isCode: true,
                        ...
                        children: [
                          Expanded(
                            child: _DetailRow(
                              ...
                              valueColor: details.expiryDate.isNotEmpty
                          ...
                          Expanded(
                            child: _DetailRow(
                              label: 'Card Holder',
                              value: details.cardHolderName.isNotEmpty
                                  ? details.cardHolderName
                                  : 'Not Found',
                              valueColor: details.cardHolderName.isNotEmpty
                                  ? const Color(0xFF0F172A)
                                  : const Color(0xFF94A3B8),
                            ),
                          ),
              ...
              if (!isLoading)
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    elevation: 2,
                    shadowColor: const Color(0xFF0F56FA).withOpacity(0.3),
                  ),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      ...
                      Text(
                        hasImage ? 'Scan Another Card' : 'Capture & Scan Card',
                        style: const TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                        ),
        ...
        return Align(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: const Color(0xFF0F56FA).withOpacity(0.8),
                  blurRadius: 10,
                  spreadRadius: 2,
                )
              ],
